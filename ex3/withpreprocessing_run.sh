...
(cd lambdas/preprocessing; pip install -r requirements.txt -t .; rm -f lambda.zip; zip -r lambda.zip .)
awslocal lambda create-function \
...
(cd lambdas/profanity-check; pip install -r requirements.txt -t .; rm -f lambda.zip; zip -r lambda.zip .)
awslocal lambda create-function \
...
(cd lambdas/sentiment-analysis; pip install -r requirements.txt -t .; rm -f lambda.zip; zip -r lambda.zip .)
awslocal lambda create-function \
